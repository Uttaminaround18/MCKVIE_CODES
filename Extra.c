...
int main()
{
    ...
    while (1)
    {
        printf("\n Press 1. Input Restricted DEQUE \n Press 2. Output Restricted DEQUE\n Press 3. Exit ");
        printf("\nEnter your choice: ");
        scanf("%d", &ch);
        ...
        case 1:
            ...
            {
                int c;
                printf("\nPress 1 for adding from rear\nPress 2 for deleting from front\nPress 3 for delelting from rear\nPress 4 Display ");
                printf("\nEnter your choice: ");
                scanf("%d", &c);
        ...
        case 2:
            while(1){
            int b;
            printf("\nPress 1 for deleting from front\nPress 2 for adding from front\nPress 3 for adding from rear\nPress 4 Display\n Press 5 to Exit ");
            printf("\nEnter your choice: ");
            scanf("%d", &b);
            switch (b)
            {
